    ...
    $.fn.extend({
        ...
        setSelection: function(selectionStart, selectionEnd) {
            ...
            if (input.createTextRange) {
                ...
                alert("selectionStart : " + selectionStart + ", window.getSelection() : " + window.getSelection());

                var range = document.createRange();
                range.collapse(true);
                range.setStart(el.childNodes[0], selectionStart); // -11 은 contenteditable 때문에 에러나서 내가 추가한 것임..
